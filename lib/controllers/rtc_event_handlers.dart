...
Future<RtcEngineEventHandler> rtcEngineEventHandler(
  ...
  }, onExtensionErrorWithContext: ( extension, error, msg,) {
    agoraEventHandlers.onExtensionError
        ?.call(extension.providerName ?? '', extension.extensionName ?? '', error, msg );
  }, onExtensionEventWithContext: ( extension, key, value) {
    agoraEventHandlers.onExtensionEvent?.call(extension.providerName ?? '', extension.extensionName ?? '', key, value);
  }, onExtensionStartedWithContext: (extension) {
    agoraEventHandlers.onExtensionStarted?.call(extension.providerName ?? '', extension.extensionName ?? '');
  }, onExtensionStoppedWithContext: (extension) {
    agoraEventHandlers.onExtensionStopped?.call(extension.providerName ?? '', extension.extensionName ?? '');
